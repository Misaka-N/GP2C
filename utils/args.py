...
def get_pretrain_args():
    ...
    parser.add_argument("--subgraphs", type=int, default=128, help="subgraph num for each node classification dataset")
    ...
    parser.add_argument("--path", type=str, default="pretrained_gnn/Amazon0.45.pth", help="model saving path")

    # Pretrain Process
    parser.add_argument("--batch_size", type=int, default=128, help="subgraph num of one batch")
    parser.add_argument("--lr", type=float, default=0.003, help="learning rate for pretraining")
...
def get_downstream_args():
    ...
    parser.add_argument("--pretrained_model", type=str, default="pretrained_gnn/Amazon0.45.pth", help="pretrained model path")
    parser.add_argument("--shot", type=int, default=20, help="shot for few-shot learning")
    ...
    parser.add_argument("--hidden_dim", type=int, default=100, help="hidden dimension")
    parser.add_argument("--output_dim", type=int, default=100, help="output dimension(also dimension of projector and answering fuction)")
    parser.add_argument("--batch_size", type=int, default=10, help="batch size for induced graphs")
    ...
    parser.add_argument("--save_component_path", type=str, default='downstream_model/prompt_pool_enzymes_task0.pth', help="prompt component saving path")
    parser.add_argument("--load_components_path", type=str, nargs='+',default=['downstream_model/prompt_pool_amazon_photo_task0.pth',
                        'downstream_model/prompt_pool_amazon_computer_task0.pth','downstream_model/prompt_pool_amazon_fraud_task0.pth'], help="FOR L2SPLUS: prompt components loading path")
