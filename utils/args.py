...
def get_pretrain_args():
    ...
    parser.add_argument("--aug_radio", type=float, nargs='+', default=[0.8, 0.2], help="Augmentation radio")
    ...
    parser.add_argument("--path", type=str, default="pretrained_gnn/Amazon_Photo+Amazon_Computer+Amazon_Fraud_Subgraph+Drop_GIN_1.pth", help="model saving path")
    ...
    parser.add_argument("--lr", type=float, default=0.0025, help="learning rate for pretraining")
